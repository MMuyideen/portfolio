...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1719852641973/876584ff-8cfd-442a-b703-1b284d07924e.png)

To validate the users created we run `id <username>`. It will show the user names and their groups.

![](https://cdn.hashnode.com/res/hashnode/image/upload/v1719852749819/51736985-4a83-4463-92df-7b83c7e2a6b0.png)

Then we verify the home directories created by running the `ls /home`

![](https://cdn.hashnode.com/res/hashnode/image/upload/v1719852800484/d7b30e71-4752-4007-b82a-fae8e3b5706b.png)

Then we check the logs by running `sudo cat /var/log/user_management.log`

![](https://cdn.hashnode.com/res/hashnode/image/upload/v1719852940200/970d1564-8fd7-4154-bb9b-a1777cfa3860.png)

We also verify the passwords for each user by running `sudo cat /var/secure/user_passwords.csv`

![](https://cdn.hashnode.com/res/hashnode/image/upload/v1719853040935/0617d4a6-eeb3-4f95-a289-84924d85ebde.png)

Lastly, we can verify group ownerships by running `groups <username>`

![](https://cdn.hashnode.com/res/hashnode/image/upload/v1719853118385/2c07b1ad-7ded-444a-ae8f-f48d855cb22f.png)
