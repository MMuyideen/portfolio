...
export function BlogPost() {
  ...
  // Rendered by scripts/build-og-image.mjs from this post's own frontmatter,
  // and regenerated by the pre-commit hook whenever a post changes.
  const card = `${SITE_URL}/og/${post.slug}.png`
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:image:alt" content={`${post.title} — muyideen.dev`} />
